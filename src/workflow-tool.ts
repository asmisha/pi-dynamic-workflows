...
const workflowToolSchema = Type.Object({
  ...
  agentRetries: Type.Optional(
    Type.Number({
      description:
        "Retry attempts for retryable agent failures such as timeout, connection failure, or empty or schema-invalid assistant output. Default 0 unless configured.",
    }),
  ),
